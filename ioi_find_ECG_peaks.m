function [periods_after_qrs_peak,bpm, qrs]=ioi_find_ECG_peaks(acqui_info,display_plots)
...
% Information about qrs peaks 
% Peaks position in seconds
qrs.peaks_position = 1e-3*qrs_peak_pos(1:end-1);
% Peaks rate in seconds
qrs.peaks_rate = 1e3./(acqui_info.line_period_us*1e-3*qrs_peak_pos_model(2:end)-qrs_peak_pos_model(1:end-1));

...
%-----------------------------------------------------------------------
matlabbatch{1}.spm.tools.ioi11.msread1.top_bin_dir = {'W:\epiRat\EP\11_10_13_test\'};
matlabbatch{1}.spm.tools.ioi11.msread1.force_redo = 1;
matlabbatch{1}.spm.tools.ioi11.msread1.output_path_choice.output_path_default = struct([]);
...
matlabbatch{2}.spm.tools.ioi11.ComputeHbConcentrations.IOImat(1).sname = 'Read Multi-Spectral IOI, new, interlaced format: IOI.mat';

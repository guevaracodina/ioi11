function imageOut = ioi_MYimresize(imageIn, nx, ny)
...
% SYNTAX
% imageOut = ioi_MYimresize(imageIn, nx, ny)
% imageOut = ioi_MYimresize(imageIn, [nx ny])
...
elseif (length(nx) == 2)
    ...
    error('ioi_MYimresize: second argument mest be a scalar or a 2-vector');
end
% Round dimensions
nx = round(nx);
ny = round(ny);

...
IOImatCopyChoice            = ioi_dfg_IOImatCopyChoice('GLMheart');
...
% Regress signal from whole image time-course
heartRate                  = cfg_menu;
heartRate.tag              = 'heartRate';
heartRate.name             = 'Regress signal from heart rate time-course';
heartRate.labels           = {'Yes','No'};
heartRate.values           = {1,0};
heartRate.val              = {0};
heartRate.help             = {'Regress signal from heart rate time-course. '};
...
fc_GLM_on_ROI1.val          = {IOImat redo1 IOImatCopyChoice ROI_choice session_choice IC transferRawData regressBrainSignal wholeImage heartRate cleanupGLM generate_figures save_figures};    % The items that belong to this branch. All items must be filled before this branch can run or produce virtual outputs

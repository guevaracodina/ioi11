...
h4g  = uimenu(h4,...
	'Label',	'Functional connectivity (fcOIS) mapping',...
	'Separator',	'off',...
	'Tag',		'Functional connectivity (fcOIS) mapping',...
...
h4k  = uimenu(h4,...
	...
	'HandleVisibility','on');
h4l  = uimenu(h4,...
	'Label',	'e-mail notifier',...
	'Separator',	'off',...
	'Tag',		'e-mail notifier',...
    'CallBack','spm_jobman(''interactive'','''',''spm.tools.ioi11.fcIOS.sendmail1'');',...
	'HandleVisibility','on');
% ------------------------------------------------------------------------------

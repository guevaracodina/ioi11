...
h4a  = uimenu(h4,...
	'Label',	'Generate Network Mask',...
	'Separator',	'off',...
	'Tag',		'Generate Network Mask',...
    'CallBack','spm_jobman(''interactive'','''',''spm.tools.ioi11.fcIOS.mask1'');',...
	'HandleVisibility','on');

h4b  = uimenu(h4,...
	'Label',	'Select Seeds for fcIOS',...
	'Separator',	'off',...
	'Tag',		'Select Seeds for fcIOS',...
    'CallBack','spm_jobman(''interactive'','''',''spm.tools.ioi11.fcIOS.seeds1'');',...
	'HandleVisibility','on');

h4c  = uimenu(h4,...
	'Label',	'Temporal filtering and downsampling',...
	'Separator',	'off',...
	'Tag',		'Temporal filtering and downsampling',...
    'CallBack','spm_jobman(''interactive'','''',''spm.tools.ioi11.fcIOS.filtdown1'');',...
	'HandleVisibility','on');

h4d  = uimenu(h4,...
	'Label',	'Seed-based functional connectivity mapping',...
	'Separator',	'off',...
	'Tag',		'Seed-based functional connectivity mapping',...
    'CallBack','spm_jobman(''interactive'','''',''spm.tools.ioi11.fcIOS.fcmap1'');',...
	'HandleVisibility','on');

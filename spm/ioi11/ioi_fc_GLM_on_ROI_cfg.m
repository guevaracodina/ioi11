...
fc_GLM_on_ROI1.val          = {IOImat redo1 IOImatCopyChoice ROI_choice session_choice IC regressBrainSignal wholeImage cleanupGLM};    % The items that belong to this branch. All items must be filled before this branch can run or produce virtual outputs

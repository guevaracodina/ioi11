...
AutoManualSeed         = cfg_branch;
AutoManualSeed.tag     = 'AutoManualSeed';
AutoManualSeed.name    = 'Manual seed selection: graphical tool'; 
AutoManualSeed.val     = {};
AutoManualSeed.help    = {'Manual seed selection: graphical tool.'}';
...
AutoSeedChoice.values    = {AutoManualSeed ManualEnterSeed AutoSeed}; 
AutoSeedChoice.val       = {AutoManualSeed}; 
...
seeds1.name = 'Create seed';             % The display name
...
seeds1.help = {'Create a circular ROI called seed'};

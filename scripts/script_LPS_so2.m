...
for iLPS = 1:nLPS,
    ...
    for iR = 1:numel(ROI),
        HbOLPS(iLPS, iR) = mean(ROI{iR}{5});
        HbRLPS(iLPS, iR) = mean(ROI{iR}{6});
        HbTLPS(iLPS, iR) = HbOLPS(iLPS, iR) + HbRLPS(iLPS, iR);
        sO2LPS(iLPS, iR) = HbOLPS(iLPS, iR) ./ HbTLPS(iLPS, iR);
    end
end
...
for iNaCl = 1:nNaCl,
    ...
    load(IOI.ROI.ROIfname)
    for iR = 1:numel(ROI),
        HbONaCl(iNaCl, iR) = mean(ROI{iR}{5});
        HbRNaCl(iNaCl, iR) = mean(ROI{iR}{6});
        HbTNaCl(iNaCl, iR) = HbONaCl(iNaCl, iR) + HbRNaCl(iNaCl, iR);
        sO2NaCl(iNaCl, iR) = HbONaCl(iNaCl, iR) ./ HbTNaCl(iNaCl, iR);
    end
end

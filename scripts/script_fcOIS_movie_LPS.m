...
%     ioi_overlay_blend(IOImat, job, images2overlay, fcMapRange, alphaRange, 256, r1, c1);
    ioi_overlay_blend(anatomical, fcMap, ...
        brainMask, fcMapRange, alphaRange, ioi_get_colormap('bipolar'), 0.6);
%     hold on

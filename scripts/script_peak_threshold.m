...
seizureDuration{1}{4} = [203-158; 375-332; 660-627; 838-806];
...
seizureDuration{7}{4} = [382-349; 566-534];

seizureDuration{9}{3} = [459-329];
seizureDuration{9}{3} = [432-271];

seizureDuration{10}{3} = NaN;
seizureDuration{10}{3} = NaN;

function script_alignment_res2
%% script_alignment
clc;
% Always 1 session
s1 = 1;
...
switch(c1)
    case 5,
        topDir = 'F:\Edgar\Data\IOS_Carotid_Res2\alignment\HbO';
        figFolder = 'F:\Edgar\Data\IOS_Carotid_Res2\alignment\figures\aligned_HbO';
    case 6,
        topDir = 'F:\Edgar\Data\IOS_Carotid_Res2\alignment\HbR';
        figFolder = 'F:\Edgar\Data\IOS_Carotid_Res2\alignment\figures\aligned_HbR';
    case 7,
        topDir = 'F:\Edgar\Data\IOS_Carotid_Res2\alignment\CBF\';
        figFolder = 'F:\Edgar\Data\IOS_Carotid_Res2\alignment\figures\aligned_CBF';
    case 8,
        topDir = 'F:\Edgar\Data\IOS_Carotid_Res2\alignment\CMRO2';
        figFolder = 'F:\Edgar\Data\IOS_Carotid_Res2\alignment\figures\aligned_CMRO2';
    otherwise
...
if strcmp(groupID, 'CC')
    load('F:\Edgar\Data\IOS_Carotid_Res2\12_10_19,CC10\GLMfcIOS\corrMap\IOI.mat');
elseif strcmp(groupID, 'NC')
    load('F:\Edgar\Data\IOS_Carotid_Res2\12_10_18,NC09\GLMfcIOS\corrMap\IOI.mat');
else
